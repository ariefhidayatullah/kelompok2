                ...
                <form action="<?= base_url(); ?>pelanggan/editProfilePel" method="POST">
                  ...
                  <tr>
                    <td>
                      ...
                      <input type="text" class="form-control" value="<?= $this->session->userdata('userData')['nama']; ?>" name="nama" id="nama">
                    </td>
                    <td>
                      <label for="email ">Email:</label>
                      <input type="email" class="form-control" value="<?= $this->session->userdata('userData')['email']; ?>" name="email" id="email" readonly>
                    </td>
                    <td>
                      <label for="no_tlp">No Telfon:</label>
                      <input type="text" class="form-control" value="<?= $this->session->userdata('userData')['no_tlp']; ?>" name="no_tlp" id="no_tlp">
                    </td>
                    <td>
                      <label for="alamat">Alamat:</label>
                      <input type="text" class="form-control" value="<?= $this->session->userdata('userData')['alamat']; ?>" name="alamat" id="alamat">
                    </td>
                  </tr>
                  <tr>
                    <td>

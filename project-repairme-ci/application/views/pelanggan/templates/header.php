    ...
    <script>
      ...
      jQuery(document).ready(function($) {
        ...
        $('#permintaan_perbaikan').on('click', function(e) {
          ...
          $('#option_barang').append('<a href="<?= base_url(); ?>pelanggan/pengajuanperbaikan" class="btn btn-primary">LAPTOP</a><a href="<?= base_url(); ?>pelanggan/pengajuanperbaikanhp" class="btn btn-primary">HANDPHONE</a>');
        });

	...
	<div class="row mt-20">
		...
		<div class="col-sm-5">
			...
			<div class="mt-80 syarat" style="margin:0 4%;">
				...
				<a href="<?= base_url(); ?>" class="btn btn-block btn-round btn-d mt-10 batal" type="button">SAYA TIDAK SETUJU</a>
			</div>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-sm-6">	
		...
		<form class="form" id="regisMitra" action="<?=base_url();?>mitra/insertMitra" method="POST" enctype="multipart/form-data">
			<div class="dataDiri">

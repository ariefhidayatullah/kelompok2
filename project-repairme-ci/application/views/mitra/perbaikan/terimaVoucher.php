<!-- daterange picker -->
<link rel="stylesheet" href="<?= base_url(); ?>panel-master/plugins/daterangepicker/daterangepicker.css">
<!-- InputMask -->
<script src="<?= base_url(); ?>panel-master/plugins/moment/moment.min.js"></script>
<!-- date-range-picker -->
<script src="<?= base_url(); ?>panel-master/plugins/daterangepicker/daterangepicker.js"></script>
          ...
          <div class="card  card-dark" style="position: absolute; right: 0; left: 0; top: 0;">
            ...
            <div class="card-body">
              ...
              <div class="waktulaptop">
                ...
                <form action="<?= base_url(); ?>mitra/vouchermasuk" method="POST">
          ...
          <div class="card  card-dark" style="position: absolute; right: 0; left: 0; top: 0;">
            ...
            <div class="card-body">
              ...
              <div class="waktuhp">
                ...
                <!-- untuk form lama perbaikan laptop -->
                <form action="<?= base_url(); ?>mitra/vouchermasuk2" method="POST">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.terimaVoucher').click(function() {
        <?php foreach ($voucher as $voucherr) : ?>
          if ("<?= $voucherr['voucher_laptop']; ?>" === $('#cariVoucher').val()) {
            <?php for ($i = 0; $i < count($perbaikan['perbaikan_laptop']); $i++) : ?>
              if ("<?= $voucherr['id_perbaikan_laptop']; ?>" === "<?= $data['perbaikan']['perbaikan_laptop'][$i]['id_perbaikan']; ?>") {
                $('#cariVoucher').val('');
                //untuk barang
      ...
      $('.terimaVoucher').click(function() {
        <?php foreach ($voucher2 as $voucherrr) : ?>
          if ("<?= $voucherrrr['voucher_hp']; ?>" === $('#cariVoucher').val()) {
            <?php for ($i = 0; $i < count($data['perbaikan2']['perbaikan_hp']); $i++) : ?>
              if ("<?= $voucherrrr['id_perbaikan_hp']; ?>" === "<?= $data['perbaikan2']['perbaikan_hp'][$i]['id_perbaikan']; ?>") {
                $('#cariVoucher').val('');
                //untuk barang

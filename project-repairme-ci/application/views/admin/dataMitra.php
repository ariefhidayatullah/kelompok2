          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="datamitra" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row">
                      ...
                      <tbody>
                        <?php foreach ($mitra as $mitra) : ?>
                          ...
                          <tr>
                            ...
                            <td><?= $mitra['no_tlp']; ?></td>
                            <td><?= $mitra['alamat']; ?></td>
                            <td><a href="<?= base_url(); ?>mitra/delete/<?= $mitra['id_mitra']; ?>" class="btn btn-block btn-danger">Hapus</a></td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
...
<script>
  $(document).ready(function() {
    $('#unduhdata').click(function() {
      // alert('oke');
      $("#datamitra").tableHTMLExport({
        type: 'csv',
        filename: 'datamitra.csv'
      });
    });
  });
</script>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?= base_url(); ?>admin/tambahpaketlagi" method="POST">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row">
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 10px;">No</th>
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 194px;">Paket</th>
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 194px;">Harga</th>
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 219px;">Opsi</th>
                        </tr>
                      </thead>
                        ...
                        <?php foreach ($paket as $paket) : ?>
                          <tr>
                            ...
                            <td>
                              <div class="row">
                                <div class="col-md-6">
                                  <a href="<?= base_url(); ?>admin/deletepaket/<?= $paket['id_paket']; ?>" class="btn btn-block btn-danger">Hapus</a>
                                </div>
                                <div class="col-md-6">
                                  <button class="btn btn-block btn-warning btn-u-paket" data-toggle="modal" data-target="#exampleModal2" value="<?= $paket['id_paket']; ?>">
                                    update
                                  </button>
                                </div>
                              </div>

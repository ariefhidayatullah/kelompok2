          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="container-fluid">
                ...
                <form action="<?= base_url(); ?>admin/tambahTipeHp" method="POST" id="formKat">
                  <div class="row">
                    <div class="col-sm-6 offset-sm-1 mt-3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url(); ?>admin/tambahMerkHp" method="POST" id="formmodmerk" data-parsley-validate="">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url(); ?>admin/tambahTipeHp" method="POST" id="formmodmerk" data-parsley-validate="">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url(); ?>admin/edittipeHp" method="POST">

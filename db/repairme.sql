...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2020 pada 22.18
...
(33, '3', '3', 'andika firmann', 'andikafirman99@gmail.com', '087756476534', 'maesan bondowoso'),
(34, '3', '6', 'ana afi', 'ana@mail.com', '081559855799', 'pal 9 bondowoso'),
(35, '3', '8', 'asfdsf', 'asdf@sadfs.df', '12312312312', 'sdfsdfdsfds'),
(44, '3', '9', 'ana percabangan', 'zbh88611@zzrgg.com', '423434234234', 'dasdsdsd');
...
(2, 2, 33, 66, 1, 4, '', 'mantap', '15 Mei 2020', 'Rp. 100.000,00'),
(3, 1, 33, 66, 0, 1, 'kena banting', 'penuh bos', '15 Mei 2020', '0');
...
(1, 2, 33, 66, 0, 4, 'mudah ', 'ramadhan', '13 Mei 2020', 'Rp. 100.000,00'),
(2, 3, 33, 66, 23, 0, 'as', '', '13 Mei 2020', ''),
(3, 1, 33, 66, 19, 4, '', '', '13 Mei 2020', '1'),
(4, 1, 33, 68, 0, 0, 'aa', '', '12 Mei 2020', '0'),
(5, 1, 33, 68, 0, 0, 'aa', '', '12 Mei 2020', '0');
...
--
ALTER TABLE `tb_voucher_hp`
  MODIFY `id_voucher_hp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `tb_voucher_laptop`
--
ALTER TABLE `tb_voucher_laptop`
  MODIFY `id_voucher_laptop` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `tb_waktu_perbaikan_laptop`
  MODIFY `id_waktu_perbaikan_laptop` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
